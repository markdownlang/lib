...
async function getReposThatMatchTemplates() {
...
async function getREADMEFromMatchingTemplate(repo) {
...
async function processRepositoryData(libs) {
    const data = {};
    for (const lib in libs) {
        if (libs[lib].fork === true)
            continue;
...
//# sourceMappingURL=fetchAllMdlibsFromGitHub.js.map